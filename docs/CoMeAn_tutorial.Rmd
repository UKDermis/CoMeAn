...
LOAD EXAMPLE FILES AS INCLUDED DATA!!!


```{r echo=FALSE, eval=FALSE}

mkdir ./inst/extdata # for raw data, like csv files
mkdir ./data # for rdata

my_example_data <- read.csv("inst/extdata/my_example_data.csv")
usethis::use_data(my_example_data, overwrite = TRUE)

# this creates: data/my_example_data.rda

#document the dataset, usually in an R/ file like R/my_example_data.R:

#' Example dataset for demonstrating XYZ
#'
#' A small example dataset included with the package.
#'
...
#' }
#' @source Simulated or derived from ...
"my_example_data"

#Then run for documentation (.Rd files in ./man):
roxygen2::roxygenise()
...
## Load demo input files: please modify LOCAL_PATH to your download directory
